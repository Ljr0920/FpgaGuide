...
elaborate()
{
  ...
  libs="-libname secureip -libname blk_mem_gen_v8_3_1 -libname xil_defaultlib"
  ncelab $opts xil_defaultlib.logo_rom $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.logo_rom -input simulate.do
}
# Script usage
usage()
{
