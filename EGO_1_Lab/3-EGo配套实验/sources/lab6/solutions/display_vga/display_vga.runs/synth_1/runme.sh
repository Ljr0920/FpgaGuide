...
HD_PWD='E:/lab/display_vga/display_vga.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_flyinglogo.vds -m64 -mode batch -messageDb vivado.pb -notrace -source top_flyinglogo.tcl
