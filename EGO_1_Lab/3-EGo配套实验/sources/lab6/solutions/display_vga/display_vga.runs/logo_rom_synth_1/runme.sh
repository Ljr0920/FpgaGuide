...
HD_PWD='E:/lab/display_vga/display_vga.runs/logo_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log logo_rom.vds -m64 -mode batch -messageDb vivado.pb -notrace -source logo_rom.tcl
