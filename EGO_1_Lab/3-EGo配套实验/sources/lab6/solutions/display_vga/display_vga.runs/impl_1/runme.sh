...
HD_PWD='E:/lab/display_vga/display_vga.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_flyinglogo.vdi -applog -m64 -messageDb vivado.pb -mode batch -source top_flyinglogo.tcl -notrace
