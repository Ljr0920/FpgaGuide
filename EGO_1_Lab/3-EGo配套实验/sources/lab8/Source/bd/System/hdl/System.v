...
(* CORE_GENERATION_INFO = "System,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=System,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=18,numReposBlks=13,numNonXlnxBlks=0,numHierBlks=5,maxHierDepth=1,da_axi4_cnt=2,da_board_cnt=3,da_mb_cnt=1,synth_mode=Global}" *) (* HW_HANDOFF = "System.hwdef" *) 
module System
   (clk,
    led_tri_o,
    uart_rtl_rxd,
  ...
  assign clock_rtl_1 = clk;
  assign led_tri_o[7:0] = axi_gpio_0_GPIO_TRI_O;
  assign uart_rtl_txd = axi_uartlite_0_UART_TxD;
  System_xlconstant_0_0 CONST_VCC
       (.dout(CONST_VCC_dout));
  ...
  System_axi_gpio_0_0 led_moudle
