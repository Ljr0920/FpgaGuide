...
HD_PWD='F:/fpga_xilinx/fpga/2016.10.24/myself/lab3_div_clk/lab3_div_clk.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log div_clk.vds -m64 -mode batch -messageDb vivado.pb -notrace -source div_clk.tcl
