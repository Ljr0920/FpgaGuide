...
HD_PWD='F:/fpga_xilinx/fpga/2016.10.24/myself/lab3_div_clk/lab3_div_clk.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log div_clk.vdi -applog -m64 -messageDb vivado.pb -mode batch -source div_clk.tcl -notrace
