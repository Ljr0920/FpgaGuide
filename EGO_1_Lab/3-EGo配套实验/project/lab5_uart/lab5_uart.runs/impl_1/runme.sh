...
HD_PWD='F:/fpga_xilinx/fpga/2016.10.25/myself/lab5_uart/lab5_uart.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_demo.vdi -applog -m64 -messageDb vivado.pb -mode batch -source uart_demo.tcl -notrace
