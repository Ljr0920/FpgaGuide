...
HD_PWD='F:/fpga_xilinx/fpga/2016.10.25/myself/lab5_uart/lab5_uart.runs/data_buf_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log data_buf.vds -m64 -mode batch -messageDb vivado.pb -notrace -source data_buf.tcl
