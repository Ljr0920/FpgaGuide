...
HD_PWD='F:/fpga_xilinx/fpga/2016.10.24/myself/lab1_flash_led/lab1_flash_led.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log flash_led_top.vdi -applog -m64 -messageDb vivado.pb -mode batch -source flash_led_top.tcl -notrace
