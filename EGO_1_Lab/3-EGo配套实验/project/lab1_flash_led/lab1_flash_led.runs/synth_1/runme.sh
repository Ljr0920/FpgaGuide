...
HD_PWD='F:/fpga_xilinx/fpga/2016.10.24/myself/lab1_flash_led/lab1_flash_led.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log flash_led_top.vds -m64 -mode batch -messageDb vivado.pb -notrace -source flash_led_top.tcl
