...
HD_PWD='F:/fpga_xilinx/fpga/2016.10.24/myself/project/lab4_filter/lab4_filter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FIR_top.vdi -applog -m64 -messageDb vivado.pb -mode batch -source FIR_top.tcl -notrace
