...
HD_PWD='F:/fpga_xilinx/fpga/2016.10.24/myself/project/lab4_filter/lab4_filter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FIR_top.vds -m64 -mode batch -messageDb vivado.pb -notrace -source FIR_top.tcl
