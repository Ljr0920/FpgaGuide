...
#
# Generated by Vivado on Mon Oct 24 18:45:23 +0800 2016
...
# Script info
echo -e "dist_mem_gen_0.sh - Script generated by export_simulation (Vivado v2015.4 (64-bit)-id)\n"
...
if [[ ($# == 1 ) && ($1 != "-lib_map_path" && $1 != "-noclean_files" && $1 != "-reset_run" && $1 != "-help" && $1 != "-h") ]]; then
  echo -e "ERROR: Unknown option specified '$1' (type \"./dist_mem_gen_0.sh -help\" for more information)\n"
  exit 1
fi
...
create_lib_mappings()
{
  libs=(dist_mem_gen_v8_0_9 xil_defaultlib)
  file="cds.lib"
  dir="ies"
...
compile()
{
  ...
  ncvhdl -work dist_mem_gen_v8_0_9 $opts_vhd \
    "$ref_dir/../../../ipstatic/dist_mem_gen_v8_0_9/simulation/dist_mem_gen_v8_0.vhd" \

  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../../lab4_filter.srcs/sources_1/ip/dist_mem_gen_0/sim/dist_mem_gen_0.vhd" \
...
elaborate()
{
  ...
  libs="-libname secureip -libname dist_mem_gen_v8_0_9 -libname xil_defaultlib"
  ncelab $opts xil_defaultlib.dist_mem_gen_0 $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.dist_mem_gen_0 -input simulate.do
}
# Script usage
usage()
{
